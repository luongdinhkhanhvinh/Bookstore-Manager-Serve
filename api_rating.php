<?php include("includes/connection.php"); 
  ...
  $qry = Insert('tbl_rating',$data); 
      ...
      $total_rat_row=mysqli_fetch_assoc($total_rat_res);
        ...
        echo '{"EBOOK_APP":[{"total_rate":'.$total_rat_row['total_rate'].',"rate_avg":'.$total_rat_row['rate_avg'].',"MSG":"Bạn đã đánh giá thành công"}]}';
        
      }else{
                
        echo '{"EBOOK_APP":[{"MSG":"Bạn đã đánh giá"}]}';
      }
   
  }
  else
  {
    echo '{"EBOOK_APP":[{"MSG":"Lỗi"}]}';
