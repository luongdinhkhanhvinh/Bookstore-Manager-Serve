        ...
        <div class="card">
		  <div class="page_title_block">
            <div class="col-md-5 col-xs-12">
              <div class="page_title">Cài đặt</div>
            </div>
          </div>
            ...
            <div class="col-md-12">
              ...
              <div class="col-md-12 col-sm-12">
                <?php if(isset($_SESSION['msg'])){?> 
                 <div class="alert alert-success alert-dismissible" role="alert"> <button type="button" class="close" data-dismiss="alert" aria-label="Thoát"><span aria-hidden="true">×</span></button>
          ...
          <div class="card-body mrg_bottom">
            ...
            <ul class="nav nav-tabs" role="tablist">
                <li role="presentation" class="active"><a href="#app_settings" aria-controls="app_settings" role="tab" data-toggle="tab">Cài đặt ứng dụng</a></li>
                <li role="presentation"><a href="#api_settings" aria-controls="api_settings" role="tab" data-toggle="tab">Cài đặt API</a></li>
                <li role="presentation"><a href="#api_privacy_policy" aria-controls="api_privacy_policy" role="tab" data-toggle="tab">Chính sách bảo mật ứng dụng</a></li>
           ...
           <div class="tab-content">
              ...
              <div class="section">
                <div class="section-body">
                  ...
                  <div class="form-group">
                    <label class="col-md-3 control-label">Logo ứng dụng :-</label>
                    <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <label class="col-md-3 control-label">Mô tả ứng dụng :-</label>
                    <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <label class="col-md-3 control-label">Phiên bản ứng dụng :-</label>
                    <div class="col-md-6">
              ...
              <div class="section">
                <div class="section-body">
                  <div class="form-group">
                    <label class="col-md-3 control-label">Giới hạn mới nhất:-</label>
                    <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <label class="col-md-3 control-label">Danh sách theo thứ tự:-</label>
                    <div class="col-md-6">
                        ...
                        <select name="api_cat_order_by" id="api_cat_order_by" class="select2">
                          ...
                          <option value="category_name" <?php if($settings_row['api_cat_order_by']=='category_name'){?>selected<?php }?>>Tên</option>
                  ...
                  <div class="form-group">
                    <label class="col-md-3 control-label">Danh mục đặt hàng:-</label>
                    <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <label class="col-md-3 control-label">Danh sách tác giả theo thứ tự:-</label>
                    <div class="col-md-6">
                        ...
                        <select name="api_author_order_by" id="api_author_order_by" class="select2">
                          ...
                          <option value="author_name" <?php if($settings_row['api_author_order_by']=='author_name'){?>selected<?php }?>>Tên</option>
                  ...
                  <div class="form-group">
                    <label class="col-md-3 control-label">Bài viết của tác giả:-</label>
                    <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <div class="col-md-9 col-md-offset-3">
                      <button type="submit" name="api_submit" class="btn btn-primary">Lưu</button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="section">
                <div class="section-body">
                  <div class="form-group">
                    <label class="col-md-3 control-label">Chính sách bảo mật ứng dụng :-</label>
                    <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <div class="col-md-9 col-md-offset-3">
                      <button type="submit" name="app_pri_poly" class="btn btn-primary">Lưu</button>
                    </div>
                  </div>
                </div>
              </div>
