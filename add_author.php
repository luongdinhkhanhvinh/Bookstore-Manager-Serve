        ...
        <div class="card">
          <div class="page_title_block">
            <div class="col-md-5 col-xs-12">
              <div class="page_title"><?php if(isset($_GET['author_id'])){?>Sửa<?php }else{?>Thêm<?php }?> Tác giả</div>
            </div>
          </div>
              ...
              <div class="section">
                <div class="section-body">
                  <div class="form-group">
                    <label class="col-md-3 control-label">Tên tác giả :-</label>
                    <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <label class="col-md-3 control-label">Hình ảnh tác giả :-</label>
                    <div class="col-md-6">
