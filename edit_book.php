        ...
        <div class="card">
          <div class="page_title_block">
            <div class="col-md-5 col-xs-12">
              <div class="page_title">Sửa sách</div>
            </div>
          </div>
            ...
            <form action="" name="addeditcategory" method="post" class="form form-horizontal" enctype="multipart/form-data">
              ...
              <div class="section">
                <div class="section-body">                 
                  ...
                  <div class="form-group">&nbsp;</div>
                  <div class="form-group">
                    <label class="col-md-3 control-label">Hình sách nổi bật :-</label>
                    <div class="col-md-6">
                  ...
                  <div class="form-group">
                    <label class="col-md-3 control-label">Hình bìa sách :-</label>
                    <div class="col-md-6">
                      <div class="fileupload_block">
                  ...
                  <div class="form-group">
                    <label class="col-md-3 control-label">Loại tập tin :-</label>
                    <div class="col-md-6">                       
                      <select name="book_file_type" id="book_file_type" style="width:280px; height:25px;" class="select2" required>
                            <option value="">--Chọn danh mục--</option>
                             <option value="server_url" <?php if($row['book_file_type']=='server_url'){?>selected<?php }?>>Từ máy chủ</option>
                            <option value="local" <?php if($row['book_file_type']=='local'){?>selected<?php }?>>Từ địa phương</option>
                      </select>
                    </div>
                  </div>
                  <div id="book_url_display" class="form-group" <?php if($row['book_file_type']=='local'){?>style="display:none;"<?php }else{?>style="display:block;"<?php }?>>
                    <label class="col-md-3 control-label">URL tập tin :-</label>
                    <div class="col-md-6">
                  ...
                  <div class="form-group" id="book_local_display" class="form-group" <?php if($row['book_file_type']=='local'){?>style="display:block;"<?php }else{?>style="display:none;"<?php }?>>
                    <label class="col-md-3 control-label">Tập tin sách :-</label>
                    <div class="col-md-6">
                      <div class="fileupload_block">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-md-6">
                      <div><label class="control-label">URL hiện hành :-</label><?php echo $row['book_file_url']?></div><br> 
                    </div>
                  </div>
