        ...
        <div class="card mrg_bottom">
          <div class="page_title_block">
            <div class="col-md-5 col-xs-12">
              <div class="page_title">Quản lý sách</div>
            </div>
            <div class="col-md-7 col-xs-12">              
                  <div class="search_list">
                    <div class="search_block">
                      <form  method="post" action="">
                        <input class="form-control input-sm" placeholder="Tìm sách..." aria-controls="DataTables_Table_0" type="search" name="book_title" required>
                        <button type="submit" name="books_search" class="btn-search"><i class="fa fa-search"></i></button>
                      </form>  
                    </div>
                    <div class="add_btn_primary"> <a href="add_book.php">Thêm sách</a> </div>
                  </div>
            ...
            <table class="table table-striped table-bordered table-hover">
              <thead>
                <tr>
				  ...
				  <th>Nổi bật</th>
				  <th>Trạng thái</th>	 
                  <th class="cat_action_list">Hoạt động</th>
                </tr>
              </thead>
              <tbody>
              	<?php
                ...
                <tr> 
		           ...
		           <td>
		              ...
		              <a href="manage_books.php?featured_deactive_id=<?php echo $books_row['id'];?>" title="Change Status"><span class="badge badge-success badge-icon"><i class="fa fa-check" aria-hidden="true"></i><span>Kích hoạt</span></span></a>

		              <?php }else{?>
		              <a href="manage_books.php?featured_active_id=<?php echo $books_row['id'];?>" title="Change Status"><span class="badge badge-danger badge-icon"><i class="fa fa-check" aria-hidden="true"></i><span>Vô hiệu hóa </span></span></a>
		              <?php }?>
              		</td>  
 		           <td>
		          		<?php if($books_row['status']!="0"){?>
		              <a href="manage_books.php?status_deactive_id=<?php echo $books_row['id'];?>" title="Change Status"><span class="badge badge-success badge-icon"><i class="fa fa-check" aria-hidden="true"></i><span>Kích hoạt</span></span></a>

		              <?php }else{?>
		              <a href="manage_books.php?status_active_id=<?php echo $books_row['id'];?>" title="Change Status"><span class="badge badge-danger badge-icon"><i class="fa fa-check" aria-hidden="true"></i><span>Vô hiệu hóa </span></span></a>
		              <?php }?>
              		</td>
                   <td><a href="edit_book.php?book_id=<?php echo $books_row['id'];?>" class="btn btn-primary">Sửa</a>
                    <a href="manage_books.php?book_id=<?php echo $books_row['id'];?>" onclick="return confirm('Bạn có chắc chắn muốn xóa sách không?');" class="btn btn-default">Xóa</a></td>
                </tr>
               <?php
